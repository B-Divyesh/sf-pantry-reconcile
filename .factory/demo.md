...
- Isolation: demo items, activity, and in-progress check state use IndexedDB database `demo:pantry-check`. Real use uses `pantry-check`; the two databases are never read or written together.
